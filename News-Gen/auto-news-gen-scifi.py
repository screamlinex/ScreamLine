#!/usr/bin/env python3
"""
auto-news-gen-scifi.py
- Uses Groq API (Mixtral) to generate structured HTML articles for Sci-Fi news.
- Downloads a main image (og:image or first <img>) into your image folder.
- Image crop requirement disabled.
...
CATEGORY = "scifi"
FEEDS = [
    "https://www.scientificamerican.com/rss/space.xml",
    "https://www.sciencenews.org/feed",
    "https://www.space.com/feeds/all",
    "https://www.coasttocoastam.com/feed/",
    "https://www.newscientist.com/feed/space/",
    "https://phys.org/rss-feed/space-news/"
]

OUTPUT_DIR = r"C:\Users\LOQ\Downloads\ScreamLine\ScreamLine\scifi"
IMAGE_DIR = r"C:\Users\LOQ\Downloads\ScreamLine\ScreamLine\img\scifi"
SEEN_FILE = os.path.join(OUTPUT_DIR, "seen_scifi.json")
MAX_PER_RUN = 5
...
def download_image_from_url(img_url, folder, title):
    if not img_url:
        return "/ScreamLine/img/scifi/dummy.jpg"
    try:
...
def generate_article_via_groq(title, summary):
    system = (
        "You are a professional science and technology journalist. "
        "Output ONLY the inner HTML content for <div class='hero'>. "
        "Start with <p class='important'><strong>Summary:</strong> ...</p>. "
        "Then write 2–5 <section> blocks with <h4> and <p> tags. "
        "Do NOT include <html>, <body>, or external tags."
    )
    ...
    try:
        ...
        return f'<p class="important"><strong>Summary:</strong> {summary}</p><section><h4>Summary</h4><p>{summary}</p></section>'
    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <a class="breadcrumb-item text-danger" href="/ScreamLine/scifi.html">Sci-Fi</a>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    <div class="position-relative mb-3">
                        ...
                        <div class="overlay position-relative bg-light">
                            <div class="mb-3">
                                <a href="" class="text-danger">Science</a>
                                <span class="px-1">/</span>
                                <span>{date}</span>
                            </div>
                            <div>
                                <h3 class="mb-3">{title}</h3>
                                <div class="hero">{hero_inner_html}</div>
                            </div>
                        </div>
                    </div>
...
def main():
    ...
    print("(Image crop check disabled — running directly.)")
    ...
    if not new_items:
        print("No more latest news, try again later.")
        return
