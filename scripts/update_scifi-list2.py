...
SCIFI_HTML = os.path.join(BASE_DIR, "scifi 2.html")
...
def get_news_files(start_index=14, limit=14):
...
def update_scifi_page():
    news_items = get_news_files(14, 14)  # get news from 15th onward (14 skipped)
    if not news_items:
